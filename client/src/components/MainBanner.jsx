  ...
  return (
    <div className='relative'>
        ...
        md:justify-center pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24'>
            ...
            max-w-50 md:max-w-80 lg:max-w-105 leading-tight lg:leading-15'>
            Sabor, Estética Y Detalle En Cada Creación!</h1>
        ...
        <div className='flex items-center mt-8 font-medium'>
            ...
            Realiza tu Pedido
            <img className='md:hidden transition group-focus:translate-x-1' src={assets.white_arrow_icon} alt="flecha" />
            </Link>

            <Link to={"/products"} className='group hidden md:flex items-center gap-2 px-9 py-3 cursor-pointer'>
            Explora Ofertas
            <img className='transition group-hover:translate-x-1' src={assets.black_arrow_icon} alt="flecha" />
            </Link>
        </div>
        </div>
    </div>
