...
const Categories = () => {
  ...
  return (
    <div className='mt-16'>
        <p className='text-2xl md:text-3xl font-medium'>Productos Principales</p>
        <div className='grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 mt-6 gap-6'>
